...
public class ShopListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent arg0)  { 
		...
		try{
			...
			context.setAttribute("userService",new WebService(new UserDAOImpl(dataSource),new RoleDAOImpl(dataSource),new UserRoleDAOImpl(dataSource),new RoleAuthorityDAOImpl(dataSource),new AuthorityDAOImpl(dataSource),new UserAuthorityDAOImpl(dataSource)));
			//int i=0;
