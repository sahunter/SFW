...
<body>
 ...
 WorkService workService = (WorkService) getServletContext().getAttribute("workService");
      ...
      List<WorkChange> Wblahs = workService.getWorkChangeWOTs();
	%>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading"><strong>历史加班记录</strong></div>
						<!-- /.panel-heading -->
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<%
													...
													<tr>
															...
															<td class="center"><%=wbh.getWorkOverTime() %></td>
											</tr>
														<%}%>
									</tbody>
								</table>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="panel panel-default">                        <!--qingjialalalalal -->
						<div class="panel-heading">员工加班信息</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="table-responsive">
							
							<form action="../UpdateWorkOverTime">
								<table class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<th>姓名</th>
									...
									<tbody>
											...
											<td><input type="text" name="thesection"></td>
										</tr>
														
									</tbody>
								</table>
								<p align="center"><input type="submit" value="提交加班信息"></p>
								</form>
							</div>
							<!-- /.table-responsive -->
						</div>
