					...
					<div class="panel panel-default">                        <!--qingjialalalalal -->
						...
						<div class="panel-body">
							<div class="table-responsive">
								...
								<form action="../DayOff">
									<label >请假日期：</label><input type="text" name="thedate" id="thedate"><br /><br />
									<label >请假时段：</label><input type="text" name="thetime" id="thetime"><br /><br />
									<label  >请假摘要：</label><textarea name="reason" rows="4" cols="28" id="reason"></textarea><br /><br />
									<p align="center"><input type="button" value="请假申请" class="item_addcart"></p>
								</form>
