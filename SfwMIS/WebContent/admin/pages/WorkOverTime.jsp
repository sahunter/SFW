...
<body>
	...
	//String seller = (String) request.getSession().getAttribute("slogin");
	    ...
	    blah.setUserName(seller);
	      List<WorkChange> blahs = workService.getWorkOverTimes(blah);
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="panel panel-default">                        <!--qingjialalalalal -->
						<div class="panel-heading">加班记录</div>
						<!-- /.panel-heading -->
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="3" align="right">&nbsp;<%=blahs.size() %></td>
										</tr>
									</tbody>
								</table>
							</div>
