						...
						<div class="panel-body">
							...
							<fieldset>
								<div class="form-group">
									用户名： <input class="form-control" placeholder="用户名"
										name="j_username" type="text"  value=<%=name %> >
								</div>
								<div class="form-group">
									密码：<input class="form-control" placeholder="密码"
										name="j_password" type="password" value=<%=psw %>>
								</div>
								<div>
