...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#sorder").click(function(){
			//alert("ok");
			$.get("../sordershow.do", function(m){
				$("table#tdata tr:gt(0)").remove();
				var html = "";
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
                     ...
                     <% if(req.getSession().getAttribute("position").equals("admin")){%> 
						...
						<!--	<ul class="nav nav-second-level">
								<!-- -->
							<!--  <li><a href="blank.jsp">添加商品页</a></li>
		...
		<div id="page-wrapper">
					...
					<div class="panel panel-primary">
						...
						<a href=" ">
							<div class="panel-footer">
								<span class="pull-left">查看详细信息</span> <span class="pull-right"><i
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									...
									<div>新活动</div>
									<!-- <div>
										<input type="button" value="新订单!" id="sorder">
									</div> -->
								</div>
							</div>
						</div>
						<a href="tablesorder.jsp">
							<div class="panel-footer">
								<span class="pull-left">查看详细信息</span> <span class="pull-right"><i
									class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
			...
			<!--   <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-bolt fa-fw"></i> 服务器崩溃!
                                    <span class="pull-right text-muted small"><em>11:13 AM</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-warning fa-fw"></i> 服务器不响应
                                    <span class="pull-right text-muted small"><em>10:57 AM</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-shopping-cart fa-fw"></i> 新下订单
                                    <span class="pull-right text-muted small"><em>9:49 AM</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-money fa-fw"></i> 付款收到了
                                    <span class="pull-right text-muted small"><em>Yesterday</em>
                                    </span>
                                </a>
                            </div>
                            <!-- /.list-group -->
			<!--   <a href="#" class="btn btn-default btn-block">查看所有警报</a>
                        </div>
                        <!-- /.panel-body -->
			<!--   </div>
                    <!-- /.panel -->
                          ...
                          聊天
                            <div class="btn-group pull-right">
                                ...
                                <ul class="dropdown-menu slidedown">
                                    ...
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-check-circle fa-fw"></i> 可用
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-times fa-fw"></i> 忙
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-clock-o fa-fw"></i> 不在线
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
			...
			<!--    <div class="panel-footer">
                            <div class="input-group">
                                <input id="btn-input" type="text" class="form-control input-sm" placeholder="编辑消息..." />
                                <span class="input-group-btn">
